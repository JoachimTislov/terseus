const files = ["../research/projects.json","../research/approaches.json","../research/iterations.json"];
Promise.all(files.map(url => fetch(url).then(r => r.json()))).then(([projects, approaches, registry]) => render(projects, approaches, registry));

function render(projects, approaches, registry) {
